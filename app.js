...
function render(){
  ...
  reminders.forEach(r=>{
    ...
    card.style.background = `linear-gradient(135deg, ${r.color}17, #FFFFFF 55%)`;
    card.style.borderColor = `${r.color}33`;
    card.innerHTML = `
      <div class="chip" style="background:${r.color}26;color:${r.color}">${r.icon}</div>
      <div class="body">
